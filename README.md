...
- Wall-clock optimization also learns the user's fast purchase/reflect handling time from adjacent purchase actions. A modeled micro-upgrade is suppressed when its predicted route saving is smaller than the empirical lower-quartile interaction cost, preventing late-run 0.01–2 second theoretical gains from costing several seconds of real manual operation.
